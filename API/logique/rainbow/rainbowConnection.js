...
class Rainbow {
    constructor(options) {
        this.sdk = new RainbowSDK({
            ...
            "credentials": {
                "login": options.email, // Bot's login to the rainbow platform
                "password": options.password // Bot's password to the rainbow platform
            },
            // Application identifier
            "application": {
                "appID": options.appId, // The Rainbow Application Identifier
                "appSecret": options.appSecret, // The Rainbow Application Secret
            },
            // Logs options
            "logs": {
